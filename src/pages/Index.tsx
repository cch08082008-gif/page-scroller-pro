                ...
                <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#adc6ff]/5 blur-[100px] rounded-full pointer-events-none"></div>
                  <form className="space-y-8 relative z-10">
                    ...
                    <div>
                      ...
                      <textarea name="message" className="w-full bg-[#131b2e] border-0 border-b-2 border-[#424754]/30 py-4 px-4 text-[#dae2fd] placeholder:text-[#c2c6d6]/30 focus:ring-0 focus:border-[#adc6ff] focus:outline-none transition-all duration-300 resize-none" placeholder={t.booking.form.msgPh} rows={4} value={message} onChange={e => setMessage(e.target.value)}></textarea>
                    </div>
                    <div className="pt-4 flex flex-col sm:flex-row gap-4">
                      <button
                        type="button"
                        onClick={sendWhatsApp}
                        className="flex-1 flex items-center justify-center gap-3 bg-[#25D366] text-white px-8 py-5 rounded-lg font-headline font-extrabold text-sm tracking-widest uppercase active:scale-95 transition-all duration-200 hover:brightness-110"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-3 bg-[#229ED9] text-white px-8 py-5 rounded-lg font-headline font-extrabold text-sm tracking-widest uppercase active:scale-95 transition-all duration-200 hover:brightness-110"
                      >
